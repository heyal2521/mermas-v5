...
<body>
  <div class="wrap">
    ...
    <h1>{esc(title)}</h1>
    <div class="sub">Panel interactivo de histórico: búsqueda, ordenación y resumen sin descargar Excel.</div>
...
"""
  ...
  <script>
    ...
    document.querySelectorAll('table thead th').forEach((th, idx) => {
      ...
      if (!table) return;
      th.addEventListener('click', () => sortTable(table, idx, th.dataset.sort || 'text'));
    });
  </script>
</body>
</html>
